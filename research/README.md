...
- [Flat delivery Effect production gap audit](./flat-delivery-production-gap-audit.md) — reviewed corrective audit: fixes the flat production Effect, `TicketDelivery` lifecycle, coloured proposal relations, accepted-fact publication, and single runtime interpreter; supersedes the earlier recommendation to postpone settlement/reflection composition.

...
## 1. Fresh-run-only starting facts
...
## 2. Synthetic recovery activation
...
## 4. Operational state versus complete state
...
## 5. Illegal early-start construction
...
## 6. Alpha-renaming implementation
...
## 7. Which identities may be renamed
...
## 10. Existing stress-test strictness
...
## 12. Size experiment representativeness
...
## 13. Starting-fact cross-field validity
...
## 14. Chronology of outside occurrences
...
## 19. Public support seams across package boundaries
...
## 20. GitHub and project-memory follow-through

...
and safe-suspension behavior](active-work-authority-refresh.md#governing-behavior)
records current facts and suspends only the exact changed subject. The accepted
[#275 capacity-blocked fresh-task handoff](discover-f-g-at-capacity.md#governing-behavior)
...
behavior](reactivate-incomplete-runs.md#several-hints-produce-one-activation-and-one-optional-trailing-check)

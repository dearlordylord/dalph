...
- `rejects reordered evidence within a present authored assertion lens`
...
| A maintainer asks for lower-level evidence | Reordering evidence in either present lens fails | `rejects reordered evidence within a present authored assertion lens` |

...
[the reported candidate reaching promotion](migrate-promotion-and-finality.md#the-reported-and-git-qualified-candidate-reaches-promotion),
...
termination belong to [#278's independent scenario](normal-termination.md), and uninterrupted DS-01–DS-22 composition belongs
...
All tests are in `packages/dalph/test/cassettes/distinct-finality.test.ts`.

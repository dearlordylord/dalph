...
[exact fixture authorization and setup-failure behavior](fixture-authorization-and-setup-failure.md),
[public failure channels](public-runner-failure-channels.md), and
[killed-child stdout framing](killed-child-stdout-framing.md).
...
[the acknowledged-read owner scenario](current-status-admission-witness.md#alice-sees-the-original-read-owner-after-its-allocated-intent-becomes-pending).

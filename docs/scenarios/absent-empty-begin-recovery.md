...
authorized, apply [the first-turn crash cuts](codex-app-server-executor.md#crash-and-retry-cuts).
This extends [the exact-idle Begin recovery](pre-turn-begin-recovery.md#chronology)

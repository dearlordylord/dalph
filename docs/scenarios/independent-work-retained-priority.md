...
[Issue #265's restart attachment](passive-executor-observation-through-restart.md#a-later-dalph-process-reattaches-to-the-exact-codex-attempt)
keeps unfinished exact attempts observable without sending another work
command. [Issue #266's active-work refresh](active-work-authority-refresh.md#alice-changes-b-while-a1-b1-and-c1-execute-autonomously)
...
[Issue #193's persistent live-request scenario](run-reactive-delivery-actions.md#one-persistent-github-claim-proposal-starts-one-live-request)
requires the ordinary accepted publication to remove a settled owner before an
independent successor starts. [Issue #194's G2 handoff](stabilize-each-run.md#g2-is-requested-only-after-g1-is-quiescent-and-reveals-b)
...
same-host Run and exact-attempt reconstruction](passive-executor-observation-through-restart.md#a-later-dalph-process-reattaches-to-the-exact-codex-attempt)
and [#266's ordinary active-work authority
recovery](active-work-authority-refresh.md#alice-changes-b-while-a1-b1-and-c1-execute-autonomously);

...
semantics](autonomous-executor-work.md#begin-once-then-observe-the-same-executing-work)
and composes them with [issue #219's retained Codex-thread
recovery](codex-app-server-executor.md#a-later-dalph-process-resumes-the-same-attempt-thread).

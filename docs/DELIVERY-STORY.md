...
DS-20|DemonstratedByMaintainedSlice|controlled:issue275ActiveGraphRefresh|packages/dalph/test/cassettes/issue-275-active-graph-refresh.test.ts#it.effect#observes F and G while B C and D remain held and admits neither until an exact position is released

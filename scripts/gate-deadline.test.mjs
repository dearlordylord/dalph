...
test("one default budget starts before admission and decreases across nesting", () => {
...
test("nested callers can shorten but never extend a persisted deadline", () => {
...
test("expired and malformed deadlines fail before launching work", () => {
...
test("timer installation consumes registration latency and immediately stops an already registered late child", () => {

...
export const acceptedResultIntegrationObligations = Object.freeze({
  ...
  witnesses: Object.freeze([
    ...
    "publicationPremiseReached",
    "publicationIntentReached",
    "publicationAttemptIntendedReached",
    ...
    "promotionRetryAuthorityRequiredReached",

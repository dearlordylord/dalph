...
import { IntegratorRunCorrelation, type IntegratorCandidateText } from "@dalph/orchestrator"
import {
...
const integratorCorrelationEquivalence = Schema.toEquivalence(IntegratorRunCorrelation)

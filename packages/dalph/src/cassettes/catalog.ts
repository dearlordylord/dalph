...
const targetLineageReadsAfterSafeObservation = targetLineagePostDeathReads
...
export const compatibleTargetAdvanceContinuesAuthoredCassette: ScenarioCassette = Schema.decodeUnknownSync(
  ...
  story: [
    ...safelySuspendedStoryBeforeAssertions,
    ...targetLineageReadsAfterSafeObservation,
    {
      _tag: "PlannedAttemptExecutorWorkReported",
      report: { _tag: "ExecutorWorkTerminal", attemptId: "attempt:A:0", result: { _tag: "Completed" } },
      request: "Resume"
...
const pipelineIntegrationPositions = {
  ...
  B: { queuedAt: 77, startedAt: 78, targetLineageObservedAt: 88 }
} as const
...
const fiveTaskDiamondIntegrationPositions = {
  ...
  B: { queuedAt: 105, startedAt: 113, targetLineageObservedAt: 128 },
  C: { queuedAt: 110, startedAt: 154, targetLineageObservedAt: 156 },
  D: { queuedAt: 229, startedAt: 230, targetLineageObservedAt: 240 },
  E: { queuedAt: 114, startedAt: 182, targetLineageObservedAt: 184 },
...
const doubleDiamondIntegrationPositions = {
  A: defaultDiamondIntegrationPositions,
  B: { queuedAt: 104, startedAt: 110, targetLineageObservedAt: 115 },
  C: { queuedAt: 107, startedAt: 145, targetLineageObservedAt: 147 },
  D: { queuedAt: 194, startedAt: 196, targetLineageObservedAt: 206 },
  E: { queuedAt: 296, startedAt: 298, targetLineageObservedAt: 310 },
  F: { queuedAt: 297, startedAt: 336, targetLineageObservedAt: 338 },
  G: { queuedAt: 487, startedAt: 488, targetLineageObservedAt: 498 },
  H: { queuedAt: 400, startedAt: 402, targetLineageObservedAt: 414 },
  I: { queuedAt: 401, startedAt: 440, targetLineageObservedAt: 442 },
  X: { queuedAt: 195, startedAt: 232, targetLineageObservedAt: 234 }
} as const satisfies Record<DoubleDiamondTaskId, DoubleDiamondIntegrationPositions>
...
export const deliveryInvariantStoryAuthoredCassette: ScenarioCassette = Schema.decodeUnknownSync(
  ...
  story: [
    ...
    { _tag: "DalphSelects", operation: { _tag: "AcquireTaskClaim", taskId: "X" } },
    ...
    {
      _tag: "DalphSelects",
      operation: { _tag: "RecordTaskAttemptPlan", attemptId: doubleDiamondAttempts.x.attemptId, taskId: "X" }
    },
    {
      _tag: "DalphSelects",
      operation: { _tag: "ReconcileTaskWorktree", attemptId: doubleDiamondAttempts.x.attemptId, taskId: "X" }
    },
    {
      _tag: "DalphSelects",
      operation: { _tag: "ReadTargetLineage", attemptId: doubleDiamondAttempts.b.attemptId, taskId: "B" }
    },
    ...doubleDiamondIntegrationFinality(
      ...
      ReturnType<typeof doubleDiamondIntegrationFinality>[number] | ReturnType<typeof doubleDiamondExecutorReport>
    >((item) =>
      item._tag === "IntegratorGitObservationReturned"
        ? [item, doubleDiamondExecutorReport(doubleDiamondAttempts.x)]
        : [item]
    ),
    {
      _tag: "DalphSelects",

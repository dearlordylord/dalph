...
import { makePositionRelease, type PositionReleaseTerminalCut } from "../../test-support/position-release.js"
import { target, integrationTarget } from "../../test-support/g5-facts.js"

type Fixture = Effect.Success<ReturnType<typeof makePositionRelease>>
const taskNames = ["B", "C", "D", "E", "F", "G"] as const

const start = Effect.fn("PositionReleaseTest.start")(function* (fixture: Fixture) {
...
const handoffs = Effect.fn("PositionReleaseTest.handoffs")(function* () {
  const fixture = yield* makePositionRelease()
...
for (const cut of [
  ...
  "AfterObservation",
  "AfterAcceptance"
] satisfies ReadonlyArray<PositionReleaseTerminalCut>) {
  it.effect(

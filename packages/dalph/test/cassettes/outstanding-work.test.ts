...
import { start, type NormalTerminationFixture } from "../../test-support/test-controls.js"

const remainsActive = Effect.fn("NormalTerminationTest.remainsActive")(function* (fixture: NormalTerminationFixture) {

...
interface NormalTerminationSettledAOperations {
  readonly seed: (input: {
...
export interface NormalTerminationSettledA extends NormalTerminationSettledAOperations {
...
export const makeNormalTerminationSettledA = Effect.fn("NormalTermination.makeSettledA")(function* (): Effect.fn.Return<
  NormalTerminationSettledA,
...
> {
  ...
  const seed = Effect.fn("NormalTermination.seedSettledA")(function* (input: {
    readonly journal: JournalStore["Service"]
    readonly evidence: EvidenceStore["Service"]
  }) {

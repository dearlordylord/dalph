...
import type { makeNormalTermination } from "./normal-termination.js"
export type NormalTerminationFixture = Effect.Success<ReturnType<typeof makeNormalTermination>>
type Fixture = NormalTerminationFixture
export const names = ["B", "C", "D", "E", "F", "G"] as const
export const start = Effect.fn("NormalTerminationTest.start")(function* (fixture: Fixture) {
...
export const deliver = Effect.fn("NormalTerminationTest.deliver")(function* (
  fixture: Fixture,

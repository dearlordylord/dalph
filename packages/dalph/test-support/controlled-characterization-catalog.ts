...
export const controlledDeliveryCharacterization = {
  attempts: {
...
export const controlledCharacterizationCatalog = { controlledDelivery: controlledDeliveryCharacterization } as const

export type ControlledCharacterizationCatalogEntry = typeof controlledDeliveryCharacterization

...
const genericOrchestrationFiles = [
  ...
  "run-recovery-activation.ts",
  "workflow-journal-history-result.ts",
  "workflow-journal-transition.ts",
  "workflow-journal-history.ts",
  ...
  "reconstructed-run-state.ts",
  "reconstructed-run.ts",

...
export const WorkflowOutcome = Schema.TaggedUnion({
  TrackerGraphObserved: { revision: TrackerRevision, taskIds: Schema.Array(TaskId) }
})
...
export const makeTrackerGraphObservedOutcome = (
  ...
  WorkflowOutcome.cases.TrackerGraphObserved.make({ revision: snapshot.revision, taskIds: snapshot.topologicalOrder() })

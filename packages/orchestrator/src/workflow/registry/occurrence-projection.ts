...
/** Version 12 removes the rejected private active-refresh Git occurrence vocabulary. */
export const workflowOccurrenceProjectionVersion = 12 as const // eslint-disable-line no-magic-numbers
...
type GitReadIntentJournalEvent = OrdinaryGitReadIntentJournalEvent
